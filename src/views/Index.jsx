  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow">
        <div className="flex flex-col md:flex-row items-center gap-3 py-8 px-6 md:py-12">
          <div className="md:w-1/3 text-justify text-white">
            <h1 className="font-bold text-4xl m-4 mb-8 text-center">
              Información Personal
            </h1>
            <p className="mb-4">
              ¡Hola! Soy Jorge Cerda un Desarrollador Web FullStack JavaScript
              con un enfoque creciente en el desarrollo de BackEnd.
            </p>
            <p className="mb-4">
            ...
            <p>
              ...
              reservadas y estoy comprometido a seguir aprendiendo y creciendo
              en el campo del desarrollo web, especialmente en el ámbito del
              BackEnd!
            </p>
          </div>
          <div className="md:w-1/3 flex flex-col text-center gap-7 text-white mt-12">
