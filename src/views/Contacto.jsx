  ...
  return (
    <>
      ...
      <div className="h-screen">
        <div className="rounded-lg shadow-xl bg-gray-500 mx-6 flex flex-col lg:flex-row gap-10 md:gap-0 mt-12">
          <div className="w-full md:w-5/6 lg:w-1/3 px-6 pt-3 lg:ms-16 text-justify">
